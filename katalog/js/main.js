            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="barang.html">Barang dan Supplier</a>
                        <a class="dropdown-item" href="jasa.html">Jasa Mekanik</a>
                        <a class="dropdown-item" href="jasae.html">Jasa Elektrik</a>
                        </div>
                    </li>
                    <li class="nav-item">
